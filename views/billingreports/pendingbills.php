                ...
                success: function(res) {
                    ...
                    if (res.length > 0) {
                        ...
                        $.each(res, (i, val) => {
                            ...
                            table_row += '<td>' + val.invoicemonth + '</td>';
                            table_row += '<td>' + val.customer_TotalAmonut + '</td>';
                            if (val.payment_Status == 1) {
                                table_row += '<td> <button class="btn btn-primary"> Paid  </button></td>';
                            } else {
                                // table_row += '<td> <a href="<?php echo base_url('getfinalinvoice/'); ?>' + val['user_Id'] + '"><button class="btn btn-danger"> Recived Payment</button></a></td>';
                                table_row += '<td> <a href="<?php echo base_url('receivedPayment/');?>' + val['user_Id']+ '"><button class="btn btn-danger"> Received Payment</button> </a> </td>'
                            }
                            table_row += '</tr>';
                        });
