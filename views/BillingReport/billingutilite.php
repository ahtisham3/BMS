  ...
  $(document).ready(function() {
    $('#building_Table').change(function() {
            ...
            $('#customer_DetailTableContainer').show();
             console.log(buildingId);
            $.ajax({
                url: '<?php echo base_url('Customer/CustomerController/getCustomerByBuildingIdForBillingReport'); ?>/' + buildingId,
                method: 'get',
                dataType: 'json',
                success: function(res) {
                 ...
                 var table_row="";
                  ...
                  {
                   table_row+='<td> <a href="<?php echo base_url('Billing/BillingInvoiceController/addUtilityBills/');?>'+ val['user_Id']+'"><button class="btn btn-danger"> Add Utilities Bills  </button></a></td>';
                  }    
                   table_row+='</tr>';
                  });
