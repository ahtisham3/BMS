                                    ...
                                    <div class="portlet light ">
                                        <div class="portlet light form-fit ">
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form action="<?php echo base_url('createfloordetail'); ?>" class="form-horizontal form-bordered" method="POST">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3">Floor Name :</label>
                                                            <div class="col-md-9">
                                                                <input type="text" id="floor_Name" class="form-control" name="floor_Name" placeholder="Enter the Floor Code" required data-parsley-trigger="change" value="<?php set_value('floor_Name'); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select id="floor_Building" class="form-control" name="floor_Building" required data-parsley-trigger="change">
                                                                    ...
                                                                    <?php foreach ($data as $row) : ?>
                                                                        <option value="<?php echo $row->building_Id; ?>" <?php echo set_select('floor_Building', $row->building_Id); ?>>
                                                            ...
                                                            <div class="col-md-9">
                                                                <select id="floor_Type" class="form-control" name="floor_Type" required data-parsley-trigger="change">
                                                                    ...
                                                                    <?php foreach ($floor_Type as $row) : ?>
                                                                        <option value="<?php echo $row->floor_TypeId; ?>" <?php echo set_select('floor_Type', $row->floor_TypeId); ?>>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" id="total_Appartments" class="form-control" required data-parsley-trigger="change" name="total_Appartments" value="<?php set_value('total_Appartments'); ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="form-check">
                                                                    ...
                                                                    <input class="form-check-input" type="radio" name="floor_Status" id="active" value="1" <?php echo set_radio('floor_Status', '1', TRUE); ?>>
                                                                    <label class="form-check-label" for="active">Floor Active</label>
                                                                </div>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="floor_Status" id="deactive" value="0" <?php echo set_radio('floor_Status', '0'); ?>>
                                                    ...
                                                    <div class="form-actions right">
                                                        <button class="btn btn-primary" id="floor_Building_hide">Add Floor</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
...
<script>
   $(document).ready(function() {
    $('#floor_Building').change(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response) {
                    ...
                    var totalfloor, floorused, remaingfloor;
                    ...
                    $('#floor_Building_hide').prop('disabled', false); // Re-enable the button
                    ...
                    if (totalfloor != floorused) {
                        ...
                        $('#floor_Building_hide').prop('disabled', true); // Disable the button
                        $('#floor_Building_hide').css('background-color', 'red');
                    }

                    // Update button color to blue
                    $('#floor_Building_hide').removeClass('btn-danger').addClass('btn-primary');
        ...
        // Update button color to blue and enable it when a new building is selected
        $('#floor_Building_hide').prop('disabled', false);
        $('#floor_Building_hide').css('background-color', '#3B71CA');
    });
});
