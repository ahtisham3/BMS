                                    ...
                                    <div class="portlet light ">
                                        <div class="portlet light form-fit ">
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form action="<?php echo base_url('createservicedetail'); ?>" class="form-horizontal form-bordered" method="POST">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3">Service Name :</label>
                                                            <div class="col-md-9">
                                                                <input type="text" id="service_Name" class="form-control" name="service_Name" required data-parsley-trigger="change" value="<?php set_value('service_Name'); ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select id="service_type" class="form-control" name="service_type" required data-parsley-trigger="change">
                                                                    <option value="">Choose...</option>
                                                                    <?php foreach ($service_type as $row) : ?>
                                                                        <option value="<?php echo $row->service_TypeId; ?>" <?php echo set_select('service_type', $row->service_TypeId); ?>>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="number" id="service_Price" class="form-control" name="service_Price" required data-parsley-trigger="change" value="<?php set_value('service_Price'); ?>" />
                                                            </div>
                                                        </div>
