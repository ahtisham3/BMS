                        ...
                        <div class="page-toolbar">
                            ...
                            <div class="btn-group btn-theme-panel">
                                <a type="button" class="btn btn-danger" onclick="exportAsPDF(<?php echo $customerDetails->customer_Id ?>);">
                                    <i class="fa fa-file-pdf-o"></i> Received Payment
                                </a>
                            </div>
                            <!-- END THEME PANEL -->
                        </div>
                                            ...
                                            <table class="table">
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <td class="text-right"><?= $billing_details->customer_TotalAmonut; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2"></td>
                                                        <td colspan="2">Discount </td>
                                                        <td class="text-right"><?= $billing_details->discontAmont  ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2"></td>
                                                        <td colspan="2">GRAND TOTAL</td>
                                                        <td class="text-right"><?= $billing_details->customer_TotalAmonut - $billing_details->discontAmont; ?></td>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                        </div>
...
<!-- <?php echo base_url('Billing/BillinginvoiceController/updatePaymentStatus/' . $customerDetails->customer_Id); ?>');"> -->